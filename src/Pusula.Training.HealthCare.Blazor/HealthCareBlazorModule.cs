...
using Pusula.Training.HealthCare.Blazor.Middlewares;
...
public class HealthCareBlazorModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        context.Services.AddSingleton<ServiceLoggingMiddleware>(); // Middleware register
    ...
    public override void OnApplicationInitialization(ApplicationInitializationContext context)
    {
        ...
        app.UseMiddleware<ServiceLoggingMiddleware>(); // Use middleware
        app.UseUnitOfWork();
